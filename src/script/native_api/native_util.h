...
public:
	...
	static std::string nativeModApiUtil::n_util_get_password_hash(std::string name, std::string raw_password);
	static bool n_util_is_yes(std::string str);
	static std::string nativeModApiUtil::n_util_get_builtin_path();
	static std::string nativeModApiUtil::n_util_get_user_path();
	static std::string nativeModApiUtil::n_util_compress(const char *data, size_t size, float level);
	static std::string nativeModApiUtil::n_util_decompress(const char *data, size_t size);
	static bool nativeModApiUtil::n_util_mkdir(const char *path);
	static std::vector<fs::DirListNode> nativeModApiUtil::n_util_get_dir_list(const char *path);
	static bool nativeModApiUtil::n_util_safe_file_write(const char *path, size_t size, const char *content);
	static int nativeModApiUtil::n_util_request_insecure_environment(std::string mod_name);

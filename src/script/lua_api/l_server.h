...
private:
	...
	static int l_native_request_shutdown(lua_State *L);

	// get_server_status()
	static int l_get_server_status(lua_State *L);
	static int l_native_get_server_status(lua_State *L);

	// get_server_uptime()
	static int l_get_server_uptime(lua_State *L);
	static int l_native_get_server_uptime(lua_State *L);

	// get_worldpath()
	static int l_get_worldpath(lua_State *L);
	static int l_native_get_worldpath(lua_State *L);

	// is_singleplayer()
	static int l_is_singleplayer(lua_State *L);
	static int l_native_is_singleplayer(lua_State *L);
	...
	static int l_native_get_modnames(lua_State *L);
	...
	static int l_native_chat_send_all(lua_State *L);

	// chat_send_player(name, text)
	static int l_chat_send_player(lua_State *L);
	static int l_native_chat_send_player(lua_State *L);
	...
	static int l_native_dynamic_add_media_raw(lua_State *L);

	// get_player_privs(name, text)
	static int l_get_player_privs(lua_State *L);
	static int l_native_get_player_privs(lua_State *L);

	// get_player_ip()
	static int l_get_player_ip(lua_State *L);
	static int l_native_get_player_ip(lua_State *L);

	// get_player_information(name)
	static int l_get_player_information(lua_State *L);
	static int l_native_get_player_information(lua_State *L);

	// get_ban_list()
	static int l_get_ban_list(lua_State *L);
	static int l_native_get_ban_list(lua_State *L);

	// get_ban_description()
	static int l_get_ban_description(lua_State *L);
	static int l_native_get_ban_description(lua_State *L);

	// ban_player()
	static int l_ban_player(lua_State *L);
	static int l_native_ban_player(lua_State *L);

	// unban_player_or_ip()
	static int l_unban_player_or_ip(lua_State *L);
	static int l_native_unban_player_or_ip(lua_State *L);

	// kick_player(name, [message]) -> success
	static int l_kick_player(lua_State *L);
	static int l_native_kick_player(lua_State *L);

	// remove_player(name)
	static int l_remove_player(lua_State *L);
	static int l_native_remove_player(lua_State *L);

	// notify_authentication_modified(name)
	static int l_notify_authentication_modified(lua_State *L);
	static int l_native_notify_authentication_modified(lua_State *L);

...
private:
	...
	static int l_native_is_attached(lua_State *L);
	static int l_is_touching_ground(lua_State *L);
	static int l_native_is_touching_ground(lua_State *L);
	static int l_is_in_liquid(lua_State *L);
	static int l_native_is_in_liquid(lua_State *L);
	static int l_is_in_liquid_stable(lua_State *L);
	static int l_native_is_in_liquid_stable(lua_State *L);
	static int l_get_liquid_viscosity(lua_State *L);
	static int l_native_get_liquid_viscosity(lua_State *L);
	static int l_is_climbing(lua_State *L);
	static int l_native_is_climbing(lua_State *L);
	static int l_swimming_vertical(lua_State *L);
	static int l_native_swimming_vertical(lua_State *L);
	...
	static int l_native_get_last_pos(lua_State *L);
	static int l_get_last_velocity(lua_State *L);
	static int l_native_get_last_velocity(lua_State *L);
	static int l_get_last_look_vertical(lua_State *L);
	static int l_native_get_last_look_vertical(lua_State *L);
	static int l_get_last_look_horizontal(lua_State *L);
	static int l_native_get_last_look_horizontal(lua_State *L);

	// get_control(self)
	static int l_get_control(lua_State *L);
	static int l_native_get_control(lua_State *L);
	...
	static int l_native_get_movement_acceleration(lua_State *L);

	// get_movement_speed(self)
	static int l_get_movement_speed(lua_State *L);
	static int l_native_get_movement_speed(lua_State *L);

	// get_movement(self)
	static int l_get_movement(lua_State *L);
	static int l_native_get_movement(lua_State *L);
